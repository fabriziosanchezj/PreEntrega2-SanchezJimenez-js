...
//     case 100:
//         alert(`${nombreUsuario} tu puntuación es de 5 puntos de ${numeroPreguntas} \n ¡Felicidades usted es un experto de futbol! ⚽💯 \n Obtuvo un promedio del ${porcentajeFinal}%`)
//         break
//     case 80<99:
//         alert(`${nombreUsuario} tu puntuación es de 4 puntos de  ${numeroPreguntas} \n ¡Felicidades usted es un gran fan de futbol! ⚽ \n Obtuvo un promedio del ${porcentajeFinal}%`)
//         break
//     case 60<80:
//         alert(`${nombreUsuario} tu puntuación es de 3 puntos de  ${numeroPreguntas} \n Usted es fanatico del futbol \n Obtuvo un promedio del ${porcentajeFinal}%`)
//         break
//     case 40<60:
//         alert(`${nombreUsuario} tu puntuación es de 2 puntos de  ${numeroPreguntas} \n Usted ve casualmente futbol \n Obtuvo un promedio del ${porcentajeFinal}%`)
//         break
//     case 20<40:
//         alert(`${nombreUsuario} tu puntuación es de 1 puntos de  ${numeroPreguntas} \n Usted deberia ver más futbol \n Obtuvo un promedio del ${porcentajeFinal}%`)
//         break
//     case 0<20:
//         alert(`${nombreUsuario} tu puntuación es de 0 puntos de  ${numeroPreguntas} \n ¿Sabe lo que es el futbol? \n Obtuvo un promedio del ${porcentajeFinal}%`)
//         break
//     default: 
